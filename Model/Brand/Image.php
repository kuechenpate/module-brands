 ...
 */
namespace Kuechenpate\Brands\Model\Brand;

use Kuechenpate\Brands\Model\Brand\Image\NotLoadInfoImageException;
...
class Image extends \Magento\Framework\Model\AbstractModel
{
    ...
    /**
     * @var \Kuechenpate\Brands\Model\Brand\Media\Config
     */
    protected $_brandMediaConfig;
     ...
     * @param \Kuechenpate\Brands\Model\Brand\Media\Config $brandMediaConfig
    ...
    public function __construct(
        ...
        \Kuechenpate\Brands\Model\Brand\Media\Config $brandMediaConfig,
        ...
        $this->_brandMediaConfig = $brandMediaConfig;
    ...
    protected function _getWatermarkFilePath()
    {
        ...
        $baseDir = $this->_brandMediaConfig->getBaseMediaPath();
    ...
    {
        $directory = $this->_brandMediaConfig->getBaseMediaPath() . '/cache';
        ...
        try {
            ...
            $tmpDirectory = $this->_brandMediaConfig->getBaseMediaPath() . '/' . $tmpDirBasename;
