...
class Placeholder implements LocalInterface
{
    ...
    public function getUrl()
    {
        if ($this->getFilePath() !== null) {
            ...
            $result = $this->assetRepo->getUrl("Kuechenpate_Brands::images/brand/placeholder/{$this->type}.jpg");
        }
    ...
    public function getPath()
    {
        if ($this->getFilePath() !== null) {
            ...
            $defaultPlaceholder = $this->assetRepo->createAsset(
                "Kuechenpate_Brands::images/brand/placeholder/{$this->type}.jpg"
            );
            try {
    ...
    public function getFilePath()
    {
        ...
        $isConfigPlaceholder = $this->scopeConfig->getValue(
            "brands/placeholder/{$this->type}_placeholder",
