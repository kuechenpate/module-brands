...
namespace Kuechenpate\Brands\Model\ResourceModel\Attribute;
...
Class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(BrandSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(BrandSetup::ENTITY_TYPE_CODE . '_eav_attribute')],
