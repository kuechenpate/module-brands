...
namespace Kuechenpate\Brands\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'Kuechenpate_Brands';
    const KEY_IS_GLOBAL = 'is_global';
    const KEY_IS_STATIC = 'static';

    protected $_eventObject = 'attribute';
    protected static $_labels = null;
    protected $_eventPrefix = BrandSetup::ENTITY_TYPE_CODE . '_attribute';

    protected function _construct()
    {
        $this->_init(\Kuechenpate\Brands\Model\ResourceModel\Attribute::class);
    }
