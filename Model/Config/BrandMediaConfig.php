...
namespace Kuechenpate\Brands\Model\Config;

use Magento\Framework\App\Config\ScopeConfigInterface;

/**
 * Config for brand media
 */
class BrandMediaConfig
{
    private const XML_PATH_BRAND_MEDIA_URL_FORMAT = 'web/url/brand_media_url_format';
    ...
    public function getMediaUrlFormat($scopeType = ScopeConfigInterface::SCOPE_TYPE_DEFAULT, $scopeCode = null): string
    {
        $value = $this->scopeConfig->getValue(
            self::XML_PATH_BRAND_MEDIA_URL_FORMAT,
            $scopeType,
            $scopeCode
        );
